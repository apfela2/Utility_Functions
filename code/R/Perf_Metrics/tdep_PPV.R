...
tdep_PPV <- function(predict.time = c(91.3, 182.6, 365.25, 547.8, 730.5), time_labels = c('91.3' = "3 Months", '182.6' = "6 Months", '365.25' = "12 Months", '547.8' = "18 Months", '730.5' = "24 Months"),
                     Stime, status, marker, data, plot.title, cut_length = 100) {
  ...
  # Make plot
  ggplot(agg.dat, aes(y = Performance, x = cut, col = Metric)) + 
    geom_line(size = 1) +
